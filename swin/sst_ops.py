...
def get_window_coors(coors, sparse_shape, window_shape, do_shift):
    ...
    # torch.bincount(batch_win_inds).max() 应该等于 win_size^2
    ...
    return batch_win_inds, coors_in_win  # batch_win_inds:每个voxel所在的总window索引（所有batch）； coors_in_win：每个voxel在自己window内的坐标索引
